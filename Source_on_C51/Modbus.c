...
//					LED0 =0;
//				else
//					LED0 = _cror_(P1,1)&0x01;
//				break;
//		case 1:
//				if (tempData)
//					LED1 = 0;
//				else
//					LED1 = _cror_(P1,1)&0x02;
//				break;
//		case 2:
//				if (tempData)
//					LED2 = 0;
//				else
//					LED2 = _cror_(P1,1)&0x04;
//				break;
//		case 3:
//				if (tempData)
//					LED3 = 0;
//				else
//					LED3 = _cror_(P1,1)&0x80;
//				break;
//		case 4:
//				if (tempData)
//					LED4 = 0;
//				else
//					LED4 = _cror_(P1,1)&0x10;
//				break;
//		case 5:
//				if (tempData)
//					LED5 = 0;
//				else
//					LED5 = _cror_(P1,1)&0x20;
//				break;
//		case 6:
//				if (tempData)
//					LED6 = 0;
//				else
//					LED6 = _cror_(P1,1)&0x40;
//				break;
//		case 7:
//				if (tempData)
//					LED7 = 0;
//				else
//					LED7 = _cror_(P1,1)&0x80;
//				break;
       case 8:  
	   			if (tempData)						  // tempData	 灯状态
				{
				 	P1=_crol_(P1,2);
				 }						            
				else
		...
		case 9:				
				...
				if ((tempData==0)&&(flag_led==1))	
				 {
					flag_led=0;										   //******
					P1=~P1;
				 }
				else if((tempData==0)&&(flag_led==0))
				{	
				 	
					flag_led=0;	

				}
				else if((tempData==1)&&(flag_led==0))
				{	
